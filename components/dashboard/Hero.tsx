    ...
    >
      <div className="flex flex-col pt-36 items-center relative">
        ...
        <div className="flex flex-col gap-14 items-center w-full z-[5]">
          ...
          <Link
            href={"/"}
            className="text-lg font-semibold px-9 py-4 bg-[#FFDF7C] outline outline-4 outline-[#D49F5E]/10 rounded-full w-fit mb-14 hover:shadow-[0_0_0_2px_black,0_8px_0_0_#FFDF7C] hover:-translate-y-2 transition-all"
          >
