    ...
    <div className="bg-white flex flex-col gap-16 pt-16">
      <div className="container mx-auto flex flex-col sm:gap-10 gap-6 sm:px-0 px-6">
        ...
        <div className="flex sm:flex-row flex-col justify-between sm:gap-0 gap-12 sm:items-center items-start">
          ...
          <CustomButton text="Apply for Access" onClick={() => { () => router.push("/pricing") }} className="text-lg font-semibold bg-white outline outline-1 outline-[#0B1934] rounded-full w-fit hover:shadow-[0_0_0_0px_black,0_8px_0_0_#0B1934] hover:-translate-y-2 px-6 py-2" />
        </div>
      </div>
      <div className="w-full relative bg-no-repeat bg-cover bg-center sm:aspect-[1440/528] h-full" style={{ backgroundImage: "url(/description.png)" }}>
        ...
        <div className="container mx-auto sm:flex hidden flex-row  h-full gap-6 py-16 ">
          <div className="w-1/3 relative flex flex-col h-full justify-end gap-9 z-[5]">
            <div className="px-12 flex flex-col gap-9 cursor-pointer" onClick={() => setSelectedTerm(0)}>
              <Image src={'/desc01.png'} width={58} height={58} alt="" className="w-14 h-14" />
          ...
          <div className="w-1/3 relative flex flex-col h-full justify-end gap-9 z-[5]">
            ...
            <div className="px-12 flex flex-col gap-9 cursor-pointer" onClick={() => setSelectedTerm(1)}>
              <Image src={'/desc02.png'} width={58} height={58} alt="" className="w-14 h-14" />
          ...
          <div className="w-1/3 relative flex flex-col h-full justify-end gap-9 z-[5]">
            ...
            <div className="px-12 flex flex-col gap-9 cursor-pointer" onClick={() => setSelectedTerm(2)}>
              <Image src={'/desc03.png'} width={58} height={58} alt="" className="w-14 h-14" />
