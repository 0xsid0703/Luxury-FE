    ...
    <div className="container mx-auto bg-white flex flex-col gap-24 py-16">
      ...
      <div className="flex flex-row gap-32 justify-center">
        ...
        <div className="flex flex-col gap-12">
          ...
          <Button className="flex flex-row py-7 px-9 w-fit text-[#FFE281] bg-[#1F1B16] rounded-full text-lg outline outline-4 outline-[#848484]/30  hover:shadow-[0_0_0_2px_black,0_8px_0_0_#FFE281] hover:-translate-y-2 transition-all hover:bg-[#1F1B16]">
